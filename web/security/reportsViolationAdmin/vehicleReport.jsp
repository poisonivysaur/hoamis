    ...
    <center>
        ...
        <form action='addVehicleReport' method="POST" align="center" id="vehicleForm">
            <table align="center" >
                ...
                <input type="hidden" value="3" name="incidentTypeID"></td>
                </tr>
                </tr>
                <tr>
            ...
            </table><a href="homepageSecurityRep.jsp"><button type ="button"> Go Back</button></a> &nbsp; &nbsp; <input type="submit" value="Submit">
        </form>
