    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-dark-gray w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
          ...
          <div class="w3-bar-block">
            ...
            <a href="HomeownerMain" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-home fa-fw"></i>  Overview</a>
            ...
            <div class="w3-bar-item w3-button" onclick="myAccFunc('activities')">
                <i class="fa fa-users fa-fw"></i>  Community  <i class="fa fa-caret-down"></i></div>
