...
<html>
    ...
    <center>
        ...
        <button><a href="officer/security/reportsViolationAdmin/ViewSecurityViolations.jsp">View Security Violation Reports</button></a>&nbsp; &nbsp;
        <button><a href="officer/security/reportsViolationAdmin/viewViolations.jsp">View My Violation Reports</button></a>
        ...
        <br /><br /><button><a href="OfficerMain">Main Menu</a></button>
    </center>
        </body>
</html>